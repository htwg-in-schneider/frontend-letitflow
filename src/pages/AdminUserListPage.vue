<template>
  <section class="max-w-6xl mx-auto p-6">
    ...
    <div v-else
         class="hidden md:grid grid-cols-12 gap-4 px-6 py-3 text-xs font-bold text-gray-400 uppercase tracking-widest border-b border-gray-100">
    ...
    <div v-if="!loading" class="flex flex-col gap-2 mt-2">
      ...
      <div v-if="users.length === 0"
           class="text-center py-20 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 mt-4">
