          ...
          <div class="bg-white border border-[#f0c9b8] rounded-xl shadow-sm overflow-hidden">
            <div class="bg-[#fff7f3] p-6 border-b border-orange-100">
              ...
              <p class="text-sm text-gray-500 mt-1">
                {{ selectedOrder ? formatDateShort(selectedOrder.orderDate || selectedOrder.createdAt) : '-' }}</p>
              <p class="text-2xl font-bold text-[#e09a82] mt-3">
                {{ selectedOrder ? formatPrice(selectedOrder.totalAmount) : '-' }}</p>
            </div>
